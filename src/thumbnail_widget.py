...
class ThumbnailWidget(QWidget):
    ...
    def set_default_thumbnail_style(self):
        ...
        self.setStyleSheet(
            f"background-color: {sk.thumbnail_widget};"
            f"border: 1px solid {sk.thumbnail_widget_border};"
            "border-radius: 2px;"
        )
        self.label_image.setStyleSheet("border: None;")
        self.set_text_style(self.text, 'inactive', sk.thumbnail_widget_text)
        self.set_text_style(self.queue_number, 'inactive', sk.thumbnail_widget_text)
    ...
    def set_selected_thumbnail_style(self):
        ...
        self.set_default_thumbnail_img()
        self.setStyleSheet(
            f"background-color: {sk.thumbnail_widget_selected};"
            f"border: 1px solid {sk.thumbnail_widget_border};"
            "border-radius: 2px;"
        )
        self.set_text_style(self.text, 'inactive', sk.thumbnail_widget_selected_text)
        self.set_text_style(self.queue_number, 'inactive', sk.thumbnail_widget_selected_text)


    def set_queued_track_thumbnail_style(self):
        self.is_queued = True
        self.is_selected = False
        self.setStyleSheet(f"background-color: {sk.thumbnail_widget_queue};")
        self.set_text_style(self.text, 'active', sk.thumbnail_widget_queue_text)
        self.set_text_style(self.queue_number, 'active', sk.thumbnail_widget_queue_text)
    ...
    def set_playing_thumbnail_style(self):
        ...
        self.setStyleSheet(
            f"background-color: {sk.thumbnail_widget_playing};"
            f"border: 2px solid {sk.thumbnail_widget_playing_border};"
            "border-radius: 2px;"
        )
        self.set_text_style(self.text, 'active', sk.thumbnail_widget_playing_text)
        self.set_text_style(self.queue_number, 'active', sk.thumbnail_widget_playing_text)
